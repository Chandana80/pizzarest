...
public class UsersTest {
    ...
    public void testConnection() throws Exception {
        ...
        WebRequest request = new GetMethodWebRequest("http://localhost:8081/pizzarest-functional-tests/users");
        try {
    ...
    public void testCreate() throws Exception {
        WebConversation conversation = new WebConversation();
        WebRequest request = new PostMethodWebRequest("http://localhost:8081/pizzarest-functional-tests/users");
        ...
        request = new GetMethodWebRequest("http://localhost:8081/pizzarest-functional-tests/users/" + userId);
